      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">How FileHub works</h2>
            <p className="text-xl text-gray-600">Powered by the open source technologies, we aim to be the true trustless immersive layer for DAO managment.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">One Link</h4>
              <p className="text-gray-600 text-center">Share your hubs like you would share a Zoom session.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Social Activities</h4>
              <p className="text-gray-600 text-center">We offer within the hubs P2P servers with chat, voice-chat and more.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Ubiquity</h4>
              <p className="text-gray-600 text-center">Works on any device with a browser. Mobile, PC or VR.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Embeddable</h4>
              <p className="text-gray-600 text-center">Like a Youtube video, you can embed your 3D spaces anywhere.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Customizable</h4>
              <p className="text-gray-600 text-center">Place widgets and edit your hub. <br></br>Figma for 3D spaces. </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Develop a widget you'd like, and launch it as an asset in our markteplace. </p>
            </div>
